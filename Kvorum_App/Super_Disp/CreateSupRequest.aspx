<%@ Page Title="" Language="C#" MasterPageFile="~/Super_Disp/Super.Master" AutoEventWireup="true" CodeBehind="CreateSupRequest.aspx.cs" Inherits="Kvorum_App.Super_Disp.CreateSupRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form>
        ...
        <label id="Supps_Sp" style="float: right; font-weight: bold; color: red; display: none">""</label>
           <label>Поставщик*</label>
        <select id="Supps">
            <option value="0">Выберите Поставщик </option>
        </select>
        <span id="disps_S" style="float: right; font-weight: bold; color: red; display: none">""</span>
        <label style="display:none">Диспетчеры*</label>
        <select style="display:none" id="disps">
            <option value="0">Выберите диспетчер </option>
        </select>
    ...
    <div id="DerModalFenster" style="display: none;">
     ...
     <script src="../Super_Disp/Utilities/SuperSupp_Utulities.js"></script>
