...
namespace Kvorum_App.Super_Disp
{
    public partial class DispRequests : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //  GiveExcel_for_Raport ( Mydb.ExecuteReadertoDataTable("select * from vw_RequestFor_Raport where MASTER_ID=878", new SqlParameter[] { }, CommandType.Text));
        }
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                using (var workbook = new XLWorkbook())
                {
                    ...
                    foreach (var column in  Columns)
                    {
                        ...
                        worksheet.Cell(letter).Value = ColName;
