<%@ Page Title="" Language="C#" MasterPageFile="~/Disp_Admin/Dispatcher.Master" AutoEventWireup="true" CodeBehind="SRequests.aspx.cs" Inherits="Kvorum_App.Disp_Admin.SRequests" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
         <div class="button">
            <a class="create" href="CreateSRequest.aspx"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;Создать</a>
        </div>
    <div class="filter">
    ...
    <div class="col-xs-7">
     ...
     <div id="dgrm_" style="display:none" class="row">
        ...
        <hr />
                    ...
                    <table id="RequestTables" class="formTable">
